# Modèle de données BDOH v7 -- Métadonnées des entités
...
| `Responsibility`    | Rôles d'acteurs sur des ressources       | Observatory, Site, Station, TimeSerie, Project, TransferFunction, Equipment, Sensor   |
...
Note : remplace bundle_timeserie et bundle_transformedtimeserie.
       Extensible sans migration : ajouter un type = ajouter une valeur à l'enum serieType.
