...
## ADR-021 — Refonte section 8 : TransferFunction analogue à TimeSerie
...
```
TRANSFORMATION
- TransformationBatch algorithmique pur :
  cas sans TransferFunctionSet (script Python, filtre, agrégation) —
  transferFunctionSet est actuellement obligatoire (1).
  A trancher si le besoin se confirme en v2.
